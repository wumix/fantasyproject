...
@section('content')
    ...
    {{--<section class="publicaciones-blog-home no-padding">--}}
        {{--<div class="container">--}}
            {{--<div class="row adm">--}}
                {{--<div class="row mywebinar">--}}
                    {{--<div class="col-sm-10">--}}
                        {{--<h1 style="font-size: 20px;"><b>England &nbsp; vs &nbsp;Bangladesh</b></h1></div>--}}
                        ...
                        {{--<div class="row" style="margin-right: 0px;">--}}
                            ...
                            {{--<div class="col-sm-6">--}}
                                {{--<p style="color: #C0C0C0;"> Date:&nbsp--}}
                                    {{--<b style="color: grey;">Thu 01, June</b></p></div>--}}
                        {{--</div>--}}
                ...
                {{--<div class="row" style="margin-right: 0px; ">--}}
                    {{--<div class="col-sm-5" style="background-color: white;">--}}
                        {{--<div class="row">--}}
                            ...
                            {{--<div class="col-sm-10">--}}
                                {{--<p style="color: #C0C0C0;"> Venue: &nbsp<b style="color: grey;">The Ovel London</b></p>--}}
                            {{--</div>--}}
        ...
        {{--</div>--}}
    {{--</section>--}}
    @foreach($fixture_details['tournament_matches'] as $match)
        <section class="publicaciones-blog-home no-padding">
            <div class="container">
                <div class="row adm">
                    <div class="row mywebinar">
                        <div class="col-sm-10">
                            <h1 style="font-size: 20px;"><b>{{$match['team_one']}} &nbsp; vs &nbsp;{{$match['team_two']}}</b></h1></div>
                    ...
                    <div class="row" style="margin-right: 0px; padding-top: 10px;">
                        ...
                        <div class="col-sm-4" style="background-color: white;">
                            <div class="row" style="margin-right: 0px;">
                                ...
                                <div class="col-sm-6">
                                    <p style="color: #C0C0C0;"> Date:&nbsp
                                        <b style="color: grey;">{{ formatDate($match['start_date'])}}</b></p></div>
                            </div>
                        ...
                        <div class="col-sm-4" style="background-color: white;">
                            <div class="row">
                                ...
                                <div class="col-sm-11">
                                    <p style="color: #C0C0C0;"> Time:&nbsp<b style="color: grey;">{{ formatTime($match['start_date'])}}</b></p>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-5" style="background-color: white;">
                            <div class="row">
                                <div class="col-sm-1">
                                    <i style="color:red;" class="fa fa-map-signs" aria-hidden="true"></i></div>
                                <div class="col-sm-10">
                                    <p style="color: #C0C0C0;"> Venue: &nbsp<b style="color: grey;">{{$match['venue']}}</b></p></div>
