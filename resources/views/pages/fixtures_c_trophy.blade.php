            ...
            <div class="row" style="margin-right: 0px; ">
                <div class="col-sm-5" style="background-color: white;">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <p style="color: #C0C0C0;"> Venue: &nbsp<b style="color: grey;">The Ovel London</b></p></div>
...
<section class="publicaciones-blog-home no-padding">
    <div class="container">
        <div class="row adm">
            <div class="row mywebinar">
                <div class="col-sm-10">
                    <h1 style="font-size: 20px;"><b>NewZealand &nbsp; vs &nbsp;Australia</b></h1></div>
                ...
                <div class="col-sm-5" style="background-color: white;">
                    <div class="row">
                        <div class="col-sm-1">
                            <i style="color:red;" class="fa fa-map-signs" aria-hidden="true"></i></div>
                        <div class="col-sm-10">
                            <p style="color: #C0C0C0;"> Venue: &nbsp<b style="color: grey;">Cardiff wales Stadium</b></p></div>
                ...
                <div class="col-sm-5" style="background-color: white;">
                    <div class="row">
                        <div class="col-sm-1">
                            <i style="color:red;" class="fa fa-map-signs" aria-hidden="true"></i></div>
                        <div class="col-sm-10">
                            <p style="color: #C0C0C0;"> Venue: &nbsp<b style="color: grey;">Cardiff wales, Cardiff</b></p></div>
