                ...
                <div class="box-body">
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control wysiwyg textarea" name="content" id="content">{{$blog['content']}} </textarea>
                        </div>
                    </div>
                    <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <label>
                                        <input 
                                            ...
                                            value="{{$row['id']}}" 
                                            type="checkbox"
                                            {!! in_array($row['id'], $selected_categories) ? 'checked':'' !!}
                                            /> {{$row['name']}}
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="input-append">
                                        <input class="form-control" id="post_image" value="{{$blog['image']}}" name="image" type="text">
