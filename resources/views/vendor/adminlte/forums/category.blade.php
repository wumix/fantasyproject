        ...
        <div class="col-md-12">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    {!! Form::open(['url' => route('addcategory'),'method'=>'POST','files'=>true]) !!}
                    <div class="form-group">
                        <label>Name</label>
                        <input required value="{!! old('name') !!}" class="form-control" id="name"
                               placeholder="Enter category Name" type="text" name="name">
                    </div>
                    <div class="form-group">
                        <label>Description</label>
                        <textarea placeholder="Enter description" required class="form-control" name="description" cols="6" ></textarea>
                    </div>
