                            ...
                            <div class="tab-pane {!! ($key == 0) ? 'active':'' !!}" id="action-{{$val['id']}}">
                                ...
                                <div id="term-{{$val['id']}}-container">
                                    ...
                                    <div id="from-to-row-{{$termPointVal['id']}}">
                                        <input value="{{$val['id']}}"
                                               name="term_score_range[{{$val['id']}}][{{$fromToCounter}}][game_term_id]"
                                               type="hidden"/>
                                        <div class="form-group">
                                            <label>From: </label>
                                            <input value="{{$termPointVal['qty_from']}}"
                                                   name="term_score_range[{{$val['id']}}][{{$fromToCounter}}][qty_from]"
                                                   class="form-control"/>
                                        </div>
                                        <div class="form-group">
                                            <label>To: </label>
                                            <input value="{{$termPointVal['qty_to']}}"
                                                   name="term_score_range[{{$val['id']}}][{{$fromToCounter}}][qty_to]"
                                                   class="form-control"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Score: </label>
                                            <input value="{{$termPointVal['points']}}"
                                                   name="term_score_range[{{$val['id']}}][{{$fromToCounter}}][points]"
                                                   class="form-control"/>
                                        </div>
                                        <div class="form-group">
                                            <a href="javascript:deleteScore('{{$termPointVal['id']}}');"
                                               class="btn btn-danger">
                                                Delete score
                                            </a>
                                        </div>
                                        <div class="clear clearfix separator"
                                    ...
                                    <!--Input already field-->
                                    <input value="{{$val['id']}}"
                                           name="term_score_range[{{$val['id']}}][{{count($termFromToPoints)+1}}][game_term_id]"
                                           type="hidden"/>
                                    <div class="form-group">
                                        <label>From: </label>
                                        <input value=""
                                               name="term_score_range[{{$val['id']}}][{{count($termFromToPoints)+1}}][qty_from]"
                                               class="form-control"/>
                                    </div>
                                    <div class="form-group">
                                        <label>To: </label>
                                        <input value=""
                                               name="term_score_range[{{$val['id']}}][{{count($termFromToPoints)+1}}][qty_to]"
                                               class="form-control"/>
                                    </div>
                                    <div class="form-group">
                                        <label>Score: </label>
                                        <input value=""
                                               name="term_score_range[{{$val['id']}}][{{count($termFromToPoints)+1}}][points]"
                                               class="form-control"/>
                                    </div>
                                ...
                                <div class="form-group">
                                    <a href="javascript:addMoreFromTo('{{$val['id']}}');"
...
<script>
    ...
    function addMoreFromTo(termId) {
        ...
        var termIdFieldName = 'term_score_range[' + termId + '][' + fieldsCounter + '][game_term_id]';
        ...
        var fromToHtml = '<input type="hidden" name="' + termIdFieldName + '" value="' + termId + '" /><div class="clear clearfix separator" style="margin: 10px 0;"></div><div class="form-group">';
