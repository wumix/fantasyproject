...
<aside class="main-sidebar">
    ...
    <!-- Sidebar Menu -->
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="#">
                    <i class='fa fa-users'></i> <span>Memberships</span> <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li><a href="{{route('showAddMembershipForm')}}">Add Membership Plan</a></li>
                    <li><a href="{{route('memberhsips')}}">Edit Membership Plan</a></li>
            ...
            <li class="treeview">
                <a href="#">
                    <i class='fa fa-users'></i> <span>Update Live Scores</span> <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li><a href="{{route('updatelivescore')}}">Update Live Score</a></li>
