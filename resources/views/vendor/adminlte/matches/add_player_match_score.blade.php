                                    ...
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   class="form-control"/>
                                            <input type="hidden" name="player_game_term_counter[{{$player_counter}}][{{$term_counter}}][game_term_id]" value="{{$row['id']}}" class="form-control"/>
                                            <input type="hidden" name="player_game_term_counter[{{$player_counter}}][{{$term_counter}}][player_id]" value="{{$player['id']}}" />
                                            <input type="hidden" name="player_game_term_counter[{{$player_counter}}][{{$term_counter}}][match_id]" value="{{$match_id}}" />
                                        </div>
                                    </td>
                                </tr>
                                @php($term_counter++)
