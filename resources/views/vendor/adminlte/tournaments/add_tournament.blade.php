            ...
            <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label>Venue</label>
                            <input required name="venue" class="form-control" type="text">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input required name="tournament_price" class="form-control" type="text">
                        </div>

                        <div class="form-group">
                            <label>Profile Picture</label>
                            <input required name="t_logo" type="file"/>
                        </div>
