                            ...
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                @foreach($tournaments_list as $row)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('editTournamentForm', ['tournament_id'=>$row['id']])}}"
                                               class="btn btn-success">
                                                <i class="fa fa-pencil"></i> Edit
                                            </a>
                                            <a href="{{route('showAddPlayerForm', ['tournament_id'=>$row['id']])}}"
                                               class="btn btn-warning">
                                                <i class="fa fa-users"></i> Add Players
                                            </a>
                                            <a href="{{route('addMaxRoles',['tournament_id'=>$row['id']])}}"
                                               class="btn btn-info">
                                                <i class="fa fa-plus"></i> Add Max Roles
                                            </a>
                                            <a href="{{route('gameTermPoints',['tournament_id'=>$row['id']])}}"
                                               class="btn btn-info">
